...
def myVGG19(include_top=True, weights='imagenet',
    ...
    # Block 3
    x = Conv2D(256, (3, 3), activation=a, padding='same', name='block3_conv1')(x)
    ...
    # Block 4
    x = Conv2D(512, (3, 3), activation=a, padding='same', name='block4_conv1')(x)
    ...
    # Block 5
    x = Conv2D(512, (3, 3), activation=a, padding='same', name='block5_conv1')(x)
    ...
    if include_top:
        ...
        x = Dense(4096, activation=a, name='fc1')(x)
